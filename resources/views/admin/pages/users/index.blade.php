        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <table id="kt_users_table" class="table table-row-bordered gy-5">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($user->is_activated == 1)
                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Aktif</span>
                                    @else
                                        <span class="badge badge-light-danger fw-bolder fs-8 px-2 py-1 ms-2">Nonaktif</span>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        {{--begin::Menu item--}}
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="setDelete('{{ route('admin.users.destroy', $user->id) }}')">Hapus</a>
                                        </div>
                                        {{--end::Menu item--}}
                                    </div>
                                    {{--end::Menu--}}
