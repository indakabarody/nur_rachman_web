        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <table id="kt_pages_table" class="table table-row-bordered gy-5">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        {{--begin::Menu item--}}
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="setDelete('{{ route('admin.pages.destroy', $page->id) }}')">Hapus</a>
                                        </div>
                                        {{--end::Menu item--}}
                                    </div>
                                    {{--end::Menu--}}
