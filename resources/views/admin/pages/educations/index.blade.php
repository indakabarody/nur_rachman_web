        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <a href="{{ route('admin.educations.create') }}" class="btn btn-primary">
                                ...
                                {{--end::Svg Icon--}}Tambah Pendidikan
                            </a>
                            {{--end::Add service--}}
                        </div>
                        {{--end::Toolbar--}}
                ...
                <div class="card-body pt-0">
                    <table id="kt_educations_table" class="table table-row-bordered gy-5">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $education->created_at->format('Y-m-d H:i:s') }}</td>
                                <td>
                                    @if ($education->show_education == 1)
                                ...
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.educations.edit', $education->id) }}" class="menu-link px-3">Edit</a>
                                        </div>
                                        {{--end::Menu item--}}
                                        {{--begin::Menu item--}}
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="setDelete('{{ route('admin.educations.destroy', $education->id) }}')">Hapus</a>
                                        </div>
                                        {{--end::Menu item--}}
                                    </div>
                                    {{--end::Menu--}}
